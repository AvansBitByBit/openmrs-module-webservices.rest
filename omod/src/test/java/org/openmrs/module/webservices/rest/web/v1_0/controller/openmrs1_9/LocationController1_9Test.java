...
public class LocationController1_9Test extends MainResourceControllerTest {
	...
	public void shouldFailToCreateLocationWithoutAName() throws Exception {
		String json = "{ \"description\":\"Location without a name\" }";
	...
	@Test(expected = ConversionException.class)
	public void shouldFailToEditLocationWithUnknownProperty() throws Exception {
		String json = "{ \"notARealProperty\":\"value\" }";

		handle(newPostRequest(getURI() + "/" + getUuid(), json));
	}

	@Test(expected = ObjectNotFoundException.class)
	public void shouldFailToGetUnknownLocationByUuid() throws Exception {
		handle(newGetRequest(getURI() + "/not-a-real-location-uuid"));
	}
	...
	@Test
	public void shouldSearchAndReturnNoLocationsIfQueryDoesNotMatch() throws Exception {
		MockHttpServletRequest req = request(RequestMethod.GET, getURI());
		req.addParameter("q", "no-location-should-match-this-query");
